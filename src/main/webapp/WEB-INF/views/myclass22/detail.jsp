	...
	<div class="form-horizontal">
		<div class="row">
			...
			<div class="control-group <c:if test="${not empty attributeerror}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute}</span>
			...
			<div class="control-group <c:if test="${not empty attribute2error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute2}</span>
			...
			<div class="control-group <c:if test="${not empty attribute3error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute3}</span>
			...
			<div class="control-group <c:if test="${not empty attribute4error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute4}</span>
			...
			<div class="control-group <c:if test="${not empty attribute5error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute5}</span>
			...
			<div class="control-group <c:if test="${not empty attribute6error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute6}</span>
			...
			<div class="control-group <c:if test="${not empty attribute7error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute7}</span>
			...
			<div class="control-group <c:if test="${not empty attribute8error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute8}</span>
			...
			<div class="control-group <c:if test="${not empty attribute9error}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.attribute9}</span>
			...
			<div class="control-group <c:if test="${not empty iderror}">error</c:if> span6">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass22.id}</span>
		...
		<div class="form-actions">
			<a class="btn btn-primary" id="edit" href="<c:url value="/myclass22/edit/${myclass22.id}"/>">Edit</a>
			<a class="btn" id="cancel" href="<c:url value="/myclass22/list"/>">Back</a>
