...
<h1>Edit MyClass22</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass22">
	<div class="row">
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass22/edit/cancel"/>">Cancel</a>
