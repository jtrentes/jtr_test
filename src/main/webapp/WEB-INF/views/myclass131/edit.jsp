...
<h1>Edit MyClass131</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass131">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
		...
		<c:set var="myclass120error">
			<form:errors path="myclass120.id" />
		...
		<div class="control-group <c:if test="${not empty myclass120error}">error</c:if> ">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass120.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass131/edit/cancel"/>">Cancel</a>
