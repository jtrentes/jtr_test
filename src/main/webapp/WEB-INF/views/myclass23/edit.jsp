...
<h1>Edit MyClass23</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass23">
	<div class="row">
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass23/edit/cancel"/>">Cancel</a>
