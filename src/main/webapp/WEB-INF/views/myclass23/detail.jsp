	...
	<div class="form-horizontal">
		<div class="row">
			...
			<div class="control-group <c:if test="${not empty attributeerror}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass23.attribute}</span>
			...
			<div class="control-group <c:if test="${not empty attribute2error}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass23.attribute2}</span>
			...
			<div class="control-group <c:if test="${not empty iderror}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass23.id}</span>
		...
		<div class="form-actions">
			<a class="btn btn-primary" id="edit" href="<c:url value="/myclass23/edit/${myclass23.id}"/>">Edit</a>
			<a class="btn" id="cancel" href="<c:url value="/myclass23/list"/>">Back</a>
