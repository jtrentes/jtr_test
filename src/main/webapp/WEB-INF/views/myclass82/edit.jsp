...
<h1>Edit MyClass82</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass82">
	<div class="row">
		...
		<div class="control-group <c:if test="${not empty attribute10error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute10input" path="attribute10" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute11error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute11input" path="attribute11" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute12error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute12input" path="attribute12" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute13error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute13input" path="attribute13" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute14error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute14input" path="attribute14" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute15error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute15input" path="attribute15" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute16error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute16input" path="attribute16" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute17error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute17input" path="attribute17" disabled="false" />
		...
		<div class="control-group <c:if test="${not empty attribute18error}">error</c:if> span6">
			...
			<div class="controls">
				<form:input id="attribute18input" path="attribute18" disabled="false" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass82/edit/cancel"/>">Cancel</a>
