...
<h1>Edit MyClass133</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass133">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
		...
		<div class="control-group <c:if test="${not empty myclass5error}">error</c:if> ">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass5.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass133/edit/cancel"/>">Cancel</a>
