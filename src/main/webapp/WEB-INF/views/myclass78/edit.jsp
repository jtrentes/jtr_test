...
<h1>Edit MyClass78</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass78">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
		...
		<div class="control-group <c:if test="${not empty myclass74error}">error</c:if> ">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass74.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass78/edit/cancel"/>">Cancel</a>
