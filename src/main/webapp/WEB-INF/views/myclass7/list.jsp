...
<h1>List MyClass7</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass7Criteria">
	<div class="row">
		...
		<div class="control-group <c:if test="${not empty myclass69error}">error</c:if> span6">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass69" />
...
<table class="table table-striped table-bordered table-condensed">
	<tr>
		...
		<th>id</th>
		<th>
			<a class="btn btn-primary pull-right" href="<c:url value="/myclass7/edit"/>">New</a>
			
		</th>
		
	</tr>
	<c:forEach items="${myClass7List}" var="myClass7">
		<tr>
			<td>${myClass7.attribute}</td>
			<td>${myClass7.attribute2}</td>
			<td>${myClass7.attribute3}</td>
			<td>${myClass7.attribute4}</td>
			<td>${myClass7.attribute5}</td>
			<td>${myClass7.attribute6}</td>
			<td>${myClass7.attribute7}</td>
			<td>${myClass7.id}</td>
			<td>
				<a class="btn" href="<c:url value="/myclass7/detail/${myClass7.id}"/>">View</a>
				<a class="btn" href="<c:url value="/myclass7/edit/${myClass7.id}"/>">Edit</a>
