...
<h1>Edit MyClass37</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass37">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass37/edit/cancel"/>">Cancel</a>
