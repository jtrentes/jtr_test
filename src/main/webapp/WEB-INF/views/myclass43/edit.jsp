...
<h1>Edit MyClass43</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass43">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
		...
		<div class="control-group <c:if test="${not empty myclass34error}">error</c:if> ">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass34.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass43/edit/cancel"/>">Cancel</a>
