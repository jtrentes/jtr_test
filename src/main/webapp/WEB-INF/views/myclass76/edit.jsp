...
<h1>Edit MyClass76</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass76">
	<div class="row">
		...
		<div class="control-group <c:if test="${not empty myclass89error}">error</c:if> span6">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass89.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass76/edit/cancel"/>">Cancel</a>
