...
<h1>List MyClass2</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass2Criteria">
	<div class="row">
...
<table class="table table-striped table-bordered table-condensed">
	<tr>
		...
		<th>id</th>
		<th>
			<a class="btn btn-primary pull-right" href="<c:url value="/myclass2/edit"/>">New</a>
			
		</th>
		
	</tr>
	<c:forEach items="${myClass2List}" var="myClass2">
		<tr>
			...
			<td>${myClass2.id}</td>
			<td>
				<a class="btn" href="<c:url value="/myclass2/detail/${myClass2.id}"/>">View</a>
				<a class="btn" href="<c:url value="/myclass2/edit/${myClass2.id}"/>">Edit</a>
