...
<h1>Edit MyClass27</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass27">
	<div class="row">
		...
		<div class="control-group <c:if test="${not empty myclass24error}">error</c:if> span6">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass24.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass27/edit/cancel"/>">Cancel</a>
