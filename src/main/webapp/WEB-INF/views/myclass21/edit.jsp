...
<h1>Edit MyClass21</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass21">
	<div class="row">
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass21/edit/cancel"/>">Cancel</a>
