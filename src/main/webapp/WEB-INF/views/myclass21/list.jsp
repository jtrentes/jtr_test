...
<h1>List MyClass21</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass21Criteria">
	<div class="row">
...
<table class="table table-striped table-bordered table-condensed">
	<tr>
		...
		<th>id</th>
		<th>
			<a class="btn btn-primary pull-right" href="<c:url value="/myclass21/edit"/>">New</a>
			
		</th>
		
	</tr>
	<c:forEach items="${myClass21List}" var="myClass21">
		<tr>
			<td>${myClass21.attribute}</td>
			<td>${myClass21.attribute2}</td>
			<td>${myClass21.attribute3}</td>
			<td>${myClass21.attribute4}</td>
			<td>${myClass21.attribute5}</td>
			<td>${myClass21.attribute6}</td>
			<td>${myClass21.attribute7}</td>
			<td>${myClass21.id}</td>
			<td>
				<a class="btn" href="<c:url value="/myclass21/detail/${myClass21.id}"/>">View</a>
				<a class="btn" href="<c:url value="/myclass21/edit/${myClass21.id}"/>">Edit</a>
