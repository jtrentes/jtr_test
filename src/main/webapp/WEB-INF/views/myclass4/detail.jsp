	...
	<div class="form-horizontal">
		<div class="row">
			...
			<div class="control-group <c:if test="${not empty attributeerror}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass4.attribute}</span>
			...
			<div class="control-group <c:if test="${not empty attribute2error}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass4.attribute2}</span>
			...
			<div class="control-group <c:if test="${not empty attribute3error}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass4.attribute3}</span>
			...
			<div class="control-group <c:if test="${not empty iderror}">error</c:if> ">
				...
				<div class="controls">
					<span class="input-large uneditable-input">${myClass4.id}</span>
		...
		<div class="form-actions">
			<a class="btn btn-primary" id="edit" href="<c:url value="/myclass4/edit/${myclass4.id}"/>">Edit</a>
			<a class="btn" id="cancel" href="<c:url value="/myclass4/list"/>">Back</a>
