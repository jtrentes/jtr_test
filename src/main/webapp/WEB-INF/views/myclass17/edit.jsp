...
<h1>Edit MyClass17</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass17">
	<div class="row">
		...
		<div class="control-group <c:if test="${not empty myclass76error}">error</c:if> span6">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass76.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass17/edit/cancel"/>">Cancel</a>
