...
<h1>Edit MyClass32</h1>
<bR />
<form:form class="form-horizontal" method="POST" modelAttribute="myClass32">
	<div class="row">
		<c:set var="iderror">
			<form:errors path="id" />
		...
		<div class="control-group <c:if test="${not empty myclass62error}">error</c:if> ">
			...
			<div class="controls">
				...
				<form:errors class="help-inline" path="myclass62.id" />
	...
	<div class="form-actions">
		...
		<a class="btn" id="cancel" href="<c:url value="/myclass32/edit/cancel"/>">Cancel</a>
